...
def main(**kwargs):
    ...
    match kwargs["reachable_type"]:
        case "static":
            ### compute SR_result
            match kwargs["purpose"]:
                case "train":
                    SR_result=TrainUtils.get_SR_result(
                        graph=graph,
...
if __name__=="__main__":
    ...
    parser.add_argument("--reachable_type",
        type=str,
        choices=[
            "static",
            "temporal"
    ...
    app_config={
        "reachable_type":args.reachable_type,
